        ...
        <div class="row gutters-5">
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
						...
						<div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" lang="en" class="form-control" name="product_weight" value="{{$product->product_weight}}">
                            </div>
                        </div>
                        <div class="form-group row">
				...
				<div class="card">
                    ...
                    <div class="card-body">
						<div class="form-group row" id="category">
                            <label class="col-lg-3 col-from-label">{{translate('Gemstone Type')}}</label>
                            <div class="col-lg-8">
                                <select class="form-control aiz-selectpicker" name="gemstone_type" id="gemstone_type" data-selected="{{ $product->gemstone_type }}" data-live-search="true" required>
						...
						<div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" lang="en" class="form-control" name="gemstone_size" value="{{$product->gemstone_size}}">
                            </div>
                        </div>
						...
						<div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" lang="en" class="form-control" name="gemstone_weight" value="{{$product->gemstone_weight}}">
                            </div>
                        </div>
...
<script type="text/javascript">
	...
	$('.is_main_group_product').on('change',function(){
		
		var selected_product_group_id = $("#product_group_id").val();
		var product_action_type = "edit";
		var product_id = '<?php echo $product->id; ?>';
		var action = "is_group_main_product";
		var class_name = 'is_main_group_product';
		
		if(selected_product_group_id != ""){
			...
			if($(this).prop('checked')){
				...
				$.ajax({
					...
					type:"POST",
					dataType : 'json',
					url:'{{ route('products.ajax-request') }}',
					data:{
					   selected_product_group_id: selected_product_group_id,
					...
					success: function(data) {
						if(data.status == 2){
							$('.is_main_group_product').prop('checked',true);
							$('.is_main_group_product').attr('checked',true);
							
							alert('please make another product main before change this'); return false;
						}
				   }
			   });
			}
		}else{
			alert('Please select any product group'); return false;
		}
	})
