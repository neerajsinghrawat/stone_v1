...
<header class="@if(get_setting('header_stikcy') == 'on')  @endif z-1020 bg-white border-bottom shadow-sm middle_header_area">
            ...
            <div class="d-flex align-items-center">
				<div class="col-auto col-xl-5 pl-0 pr-3 d-flex align-items-center">
					...
					<div class="home_contact">
						...
						<p><a href="tel:{{ get_setting('contact_phone') }}">{{ get_setting('contact_phone') }}</a></p>
						</div>
					</div>
				</div>
                <div class="col-auto col-xl-4 pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                        ...
                        @endphp
                        @if($header_logo != null)
                            <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-100px" height="40">
                        @else
    ...
    @if ( get_setting('header_menu_labels') !=  null )
        <div class="bg-white top_last_header border-top border-gray-200 py-2">
            <div class="container">
			<div  class="col-xl-12">
				<div class="col-auto col-xl-8 float-left menu_area">
			...
			<div class="col-auto col-xl-4  float-right search_area">
